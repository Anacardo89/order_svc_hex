...
func (OrderStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_contracts_orders_order_proto_enumTypes[0].Descriptor()
}

func (OrderStatus) Type() protoreflect.EnumType {
	return &file_contracts_orders_order_proto_enumTypes[0]
}
...
func (OrderStatus) EnumDescriptor() ([]byte, []int) {
	return file_contracts_orders_order_proto_rawDescGZIP(), []int{0}
}
...
func (x *Order) Reset() {
	*x = Order{}
	mi := &file_contracts_orders_order_proto_msgTypes[0]
...
func (x *GetOrderByIDRequest) Reset() {
	*x = GetOrderByIDRequest{}
	mi := &file_contracts_orders_order_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetOrderByIDRequest) Descriptor() ([]byte, []int) {
	return file_contracts_orders_order_proto_rawDescGZIP(), []int{1}
}
...
var File_contracts_orders_order_proto protoreflect.FileDescriptor

const file_contracts_orders_order_proto_rawDesc = "" +
	"\n" +
	"\x1ccontracts/orders/order.proto\x12\x05order\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa2\x02\n" +
	"\x05Order\x12\x0e\n" +
...
var (
	...
	file_contracts_orders_order_proto_rawDescData []byte
)

func file_contracts_orders_order_proto_rawDescGZIP() []byte {
	file_contracts_orders_order_proto_rawDescOnce.Do(func() {
		file_contracts_orders_order_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_contracts_orders_order_proto_rawDesc), len(file_contracts_orders_order_proto_rawDesc)))
	})
	return file_contracts_orders_order_proto_rawDescData
}
...
func init() { file_contracts_orders_order_proto_init() }
func file_contracts_orders_order_proto_init() {
	if File_contracts_orders_order_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_contracts_orders_order_proto_rawDesc), len(file_contracts_orders_order_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_contracts_orders_order_proto_goTypes,
		DependencyIndexes: file_contracts_orders_order_proto_depIdxs,
		EnumInfos:         file_contracts_orders_order_proto_enumTypes,
		MessageInfos:      file_contracts_orders_order_proto_msgTypes,
	}.Build()
	File_contracts_orders_order_proto = out.File
	file_contracts_orders_order_proto_goTypes = nil
	file_contracts_orders_order_proto_depIdxs = nil
}
